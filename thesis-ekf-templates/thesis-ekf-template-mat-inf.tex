...
A buffer kapuhoz hasonlóan nem végez műveletet, helyben hagyja a kvantumbiteket. Azonosság transzformációként működik, alakja:
...
A klasszikus NOT kapunak felel meg, bit-flipnek is hívják. A Bloch gömb $X$ tengelyére tükröz. Alakja:
...
Az X kapu hatására a valószínűségi amplitúdók cserélődnek.
...
Az X kapuhoz hasonlóan felcseréli a $\ket{0}$-t és az $\ket{1}$-t, viszont az Y kapu a relatív fázist is megváltoztatja. A Bloch gömb $Y$ tengelyére tükröz Alakja:
...
Phase-flip kapunak is hívják, ebből adódóan a fázist cseréli meg. A Bloch gömb $Z$ tengelyére tükröz. Alakja:
...
Látható, hogy a Z kapu csak az $\ket{1}$ valószínűségi amplitúdót változtatja.
...
A Hadamard kapu segítségével a már említett szuperpozíciós állapotokat lehet előállítani. Alakja:
